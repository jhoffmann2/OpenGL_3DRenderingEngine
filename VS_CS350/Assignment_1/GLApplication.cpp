...
int main()
{
    ...
    scene = new Assignment1Scene( windowWidth, windowHeight );
...
void KeyCallback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
  dynamic_cast<Assignment1Scene*>(scene)->KeyCallback(window, key, scancode, action, mods);
}